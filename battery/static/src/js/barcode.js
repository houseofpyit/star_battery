odoo.define("dynamic_report.barcode_managemant_rpt",function (require) {
    'use strict';
    ...
    var barcodeconc = AbstractAction.extend({
        template: 'DynamicStk',
        ...
        load_data: function () {
            ...
            self._rpc({
                model: 'barcode.managemant.rpt.wizard',
                method: 'get_report_barcode',
                args: [self.wizard_id],
            }).then(function (datas) {
                console.log(datas)
    ...
    core.action_registry.add('barcode.managemant.rpt', barcodeconc);core.action_registry;
});
